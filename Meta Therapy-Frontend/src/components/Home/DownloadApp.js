...
const DownloadApp = () => {
  return (
    <>
      <section class="text-gray-600 body-font px-5 bg-gray-100">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              Download the metaTherapy app
            </h1>
            <p class="mb-8 leading-relaxed">
              Access video consultation with India’s top doctors on the
              metaTherapy app, Connect with doctors online, available 24/7, from
            ...
            <div class="flex w-full md:justify-start justify-center items-end">
              <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
                ...
                <input
                  ...
                  id="hero-field"
                  name="hero-field"
                  class="w-full bg-gray-200 bg-opacity-50 rounded border border-gray-300 focus:ring-2 focus:ring-blue-200 focus:bg-transparent focus:border-blue-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
